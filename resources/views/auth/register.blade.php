...
<div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        <div class="mb-8 text-center">
            ...
            <h1 class="mt-4 text-2xl font-bold text-gray-800">Create an Account</h1>
            <p class="text-sm text-gray-600">Get started by creating your account.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <div class="relative mt-2">
                    ...
                    <x-text-input id="name" class="block w-full rounded-lg border-gray-300 py-2.5 pl-10" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="John Doe" />
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative mt-2">
                    ...
                    <x-text-input id="email" class="block w-full rounded-lg border-gray-300 py-2.5 pl-10" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="you@example.com" />
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative mt-2">
                    ...
                    <x-text-input id="password" class="block w-full rounded-lg border-gray-300 py-2.5 pl-10" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative mt-2">
                    ...
                    <x-text-input id="password_confirmation" class="block w-full rounded-lg border-gray-300 py-2.5 pl-10" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
                </div>
