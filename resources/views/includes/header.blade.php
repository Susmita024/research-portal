<header class="bg-blue-600 text-white p-4 shadow-lg">
    <nav class="container mx-auto flex justify-between items-center flex-wrap">
        ...
        <div id="desktop-menu" class="hidden md:flex items-center space-x-4">
            ...
            <a href="/" class="p-2 rounded-md {{ request()->routeIs('contact') ? 'bg-blue-500' : 'hover:bg-blue-500' }} transition duration-300">Submit</a>
            ...
            @guest
                <a href="/" class="p-2 rounded-md hover:bg-blue-500 transition duration-300">Login</a>
                <a href="/" class="p-2 rounded-md hover:bg-blue-500 transition duration-300">Register</a>
            @endguest
        </div>
    </nav>
